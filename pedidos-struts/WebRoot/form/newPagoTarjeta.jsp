...
<html> 
	...
	<body>
		<html:form action="/guardarPago"> 
			...
			Fecha del Pago:<html:text  property="fechaPago" styleId="datepicker" lang="es" /><br/>  	
			...
			Numero de Tarjeta : <input type="text" name="numeroTarjeta"/><br/>
			Mes de Vencimiento : <input type="text" name="mesVence"/><br/>
			Ano de Vencimiento :<input type="text" name="anyoVence"/><br/>  
